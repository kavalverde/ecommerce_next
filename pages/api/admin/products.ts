...
const updateProduct = async (
  ...
  //TODO: posiblemente tendremos un localhost:3000/products/asdsad.jpg
  ...
  try {
    ...
    //TODO: Eliminar imagenes anteriores
    product.images.forEach(async (image) => {
      if (!images.includes(image)) {
        ...
        await clodinary.uploader.destroy(fileID);
      }
    });
...
const createProduct = async (
  ...
  if (!Array.isArray(images) || images.length < 2) {
    return res
      .status(400)
      .json({ message: "El producto debe tener al menos 2 imagenes" });
  }
  //TODO: posiblemente tendremos un localhost:3000/products/asdsad.jpg
